...
const en = {
    message: {
        ...
        'operation': 'Operation',
        'newJob': 'New job',
        'inputJob': 'Batch Input Job',
        'exportJob': 'Batch Export Job',
        'jobDescription': 'Job description',
        'jobParams': 'Job params',
        'timeExpressionType': 'Time expression type',
        'dispatchStrategy': 'Dispatch strategy',
        'timeExpressionPlaceHolder': 'Cron expression or spring time(1s、1h) for fixed_rate/fixed_delay job',
